...
**Hardware.** Não há compra de servidores próprios. O processamento e o armazenamento são provisionados de forma elástica em nuvem, e os colaboradores acessam a plataforma pelo navegador nos equipamentos que já utilizam. Isso reduz o custo inicial e o prazo de implantação.
...
Um diferencial menos óbvio está no público predominante do banco. Como boa parte dos clientes é formada por trabalhadores informais e microempreendedores, o score de crédito tradicional, baseado em histórico formal, tende a sub-aprovar bons pagadores desse perfil apenas por falta de registro. Ao cruzar o score com a renda estimada pelas movimentações e, mediante consentimento, com os dados de Open Finance já citados, a plataforma enxerga capacidade de pagamento que os concorrentes presos ao score isolado não captam, o que ajuda a aprovar bons clientes que hoje seriam recusados. O ponto de atenção é o risco de viés contra esse mesmo público, razão pela qual a decisão final permanece com o analista, que pondera o contexto do cliente diante da recomendação.
