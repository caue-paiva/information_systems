...
\hypersetup{colorlinks=true, urlcolor=linkblue, linkcolor=black, citecolor=black, filecolor=black}
...
\begin{tabular}{|p{3.3cm}|p{3.0cm}|p{2.4cm}|p{5.4cm}|}
\hline
...
O prot\'otipo naveg\'avel das telas que ilustram esse cen\'ario est\'a dispon\'ivel, com permiss\~ao de visualiza\c{c}\~ao, em: \href{https://www.figma.com/proto/UnsN2hce1k4KrknhDKC4pH/Horizonte-360-Prototipo?node-id=0-1&t=61Jzl2soGHWPf1rG-1}{Prot\'otipo Horizonte 360 no Figma}.
...
\textbf{Hardware.} N\~ao h\'a compra de servidores pr\'oprios. O processamento e o armazenamento s\~ao provisionados de forma el\'astica em nuvem, e os colaboradores acessam a plataforma pelo navegador nos equipamentos que j\'a utilizam. Isso reduz o custo inicial e o prazo de implanta\c{c}\~ao.
...
O \textbf{processo de concess\~ao de cr\'edito} precisa ser revisto para que as etapas de cadastro, an\'alise e decis\~ao passem a compartilhar a mesma base, em vez de operar em sequ\^encia isolada. Isso exige redefinir pap\'eis e responsabilidades e criar, ainda que de forma enxuta, uma \'area ou comit\^e de dados que coordene a iniciativa. Em termos de recursos, o projeto demanda uma equipe de integra\c{c}\~ao, profissionais de an\'alise de dados e, sobretudo, patroc\'inio da diretoria, pois se trata de uma decis\~ao organizacional, e n\~ao de uma escolha restrita \`a \'area de tecnologia. A ado\c{c}\~ao tamb\'em exige um plano de treinamento das equipes de cr\'edito e atendimento na nova ferramenta, para que confiem na informa\c{c}\~ao consolidada e a incorporem \`a rotina.
...
\small
\renewcommand{\arraystretch}{1.3}
\begin{tabular}{|p{3.6cm}|p{5.7cm}|p{5.2cm}|}
\hline
...
Um diferencial menos \'obvio est\'a no p\'ublico predominante do banco. Como boa parte dos clientes \'e formada por trabalhadores informais e microempreendedores, o score de cr\'edito tradicional, baseado em hist\'orico formal, tende a sub-aprovar bons pagadores desse perfil apenas por falta de registro. Ao cruzar o score com a renda estimada pelas movimenta\c{c}\~oes e, mediante consentimento, com os dados de Open Finance j\'a citados, a plataforma enxerga capacidade de pagamento que os concorrentes presos ao score isolado n\~ao captam, o que ajuda a aprovar bons clientes que hoje seriam recusados. O ponto de aten\c{c}\~ao \'e o risco de vi\'es contra esse mesmo p\'ublico, raz\~ao pela qual a decis\~ao final permanece com o analista, que pondera o contexto do cliente diante da recomenda\c{c}\~ao.
...
% ---- Nota de IA (secao 5, numerada) ----
\section{Nota sobre o uso de ferramentas de Intelig\^encia Artificial}

Em conformidade com a exig\^encia de transpar\^encia do enunciado, o grupo registra que ferramentas de Intelig\^encia Artificial foram utilizadas como apoio nas seguintes etapas: organiza\c{c}\~ao da estrutura do texto conforme o roteiro do projeto, revis\~ao de reda\c{c}\~ao e infograma, coes\~ao, melhora da escrita e apoio \`a sistematiza\c{c}\~ao das ideias discutidas pelo grupo, dando feedbacks sobre pontos de melhoria. Al\'em disso, a Intelig\^encia Artificial foi usada no desenvolvimento do prot\'otipo, por meio do MCP do Figma para utilizar agentes de IA que auxiliassem e fornecessem apoio no desenvolvimento das telas da plataforma Horizonte 360. A defini\c{c}\~ao do problema, o recorte de escopo, as decis\~oes de solu\c{c}\~ao e a valida\c{c}\~ao do conte\'udo \`a luz do material da disciplina foram conduzidas pelos integrantes.
