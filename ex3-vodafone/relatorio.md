...
O caso Vodafone ilustra com clareza por que um Sistema de Informação não se reduz a software. A empresa tinha tecnologia de sobra e dados em abundância, mas operava fragmentada porque seus sistemas, processos e equipes não convergiam. O que de fato destravou a transformação foi o trabalho simultâneo nas três dimensões do Sistema de Informação. Do lado da **tecnologia**, a empresa substituiu os sistemas legados por uma base de dados comum e integrada no SAP. A **organização** ganhou processos padronizados e serviços compartilhados. Por fim, junto às **pessoas**, foram trabalhados a resistência, o treinamento e a facilidade de uso.
